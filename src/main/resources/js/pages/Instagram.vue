        ...
        <v-col>
          <v-card wight="950" outlined tile>
            <v-card-title>
              ...
              <div class="headline font-weight-light">Instagram&nbsp;</div>
              <span class="headline font-weight-light">{{ instProfile.username }}</span>
            </v-card-title>
              ...
              <v-row>
                ...
                <v-col cols="4" class="pt-0">
                  ...
                  <v-row>
                    <v-col>
                      <v-btn text outlined>
                        <div @click="openFollowersDialog()" class="font-weight-light">Followers:&nbsp;<span
                            class="font-weight-medium">{{ instProfile.followers_count }}</span></div>
                      </v-btn>

                      <v-dialog v-model="dialogFollowers" max-width="1500">
                        <v-card>
                          <v-card-title class="pb-0">
                            <div class="font-weight-light headline">Your&nbsp;<span
                                class="font-weight-medium">{{ instProfile.followers_count }}</span> followers from last
                              to first
                            </div>
                          </v-card-title>
                          <v-card-actions>
                  ...
                  <v-row>
                    <v-col>
                      <v-btn text outlined>
                        <div class="font-weight-light">Following:&nbsp;<span
                            class="font-weight-medium">{{ instProfile.follows_count }}</span></div>
                      </v-btn>
                    </v-col>
                  </v-row>
                </v-col>
